...
* [`flutter_example_apps`](https://github.com/bizz84/flutter_example_apps) Open source Flutter apps and projects, as part of my tutorials at [CodeWithAndrea.com](https://codewithandrea.com/).
...
* [`flutter_opentrivia`](https://github.com/lohanidamodar/flutter_opentrivia) A quiz app in flutter using the [open trivia api](https://opentdb.com/).
...
* [`flutter_sticky_infinite_list`](https://github.com/TatsuUkraine/flutter_sticky_infinite_list) Multi directional infinite list with Sticky headers for Flutter applications.
...
* [`super_tooltip`](https://github.com/escamoteur/super_tooltip) Display ToolTips in an overlay of the screen.
